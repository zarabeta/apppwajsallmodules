...
const UserTabs = ["Products", "Productos", "Estatus", "Informacion rastreo", "Actualizacion rastreo"];

const ProductsNavTab = ({ currentRowInUserTab, setCurrentNameTabInUserTab }) => {
        const [currenTabIndex, setCurrentTabIndex] = useState(1);
