...
import AddActRastreoModal from "../modals/AddActRastreoModal";
...
const ActRastreoTable = ({ }) => {
  ...
  ////////////modal
  const [AddActRastreoShowModal, setAddActRastreoShowModal] = useState(false);
  const handleUpdateActRastreoData = async () => {
    try {
      const updatedActRastreoData = await getAllActRastreo();
      setActRastreoData(updatedActRastreoData);
  ...
  return (
    <Box>
              ...
              <Stack direction="row" sx={{ m: 1 }}>
                <Box>
                  <Tooltip title="Agregar">
                    <IconButton
                      onClick={() => setAddActRastreoShowModal(true)}>
                      <AddCircleIcon />
                    </IconButton>
                  </Tooltip>
      ...
      {/* M O D A L E S */}
      <Dialog open={AddActRastreoShowModal}>
        <AddActRastreoModal
          AddActRastreoShowModal={AddActRastreoShowModal}
          setAddActRastreoShowModal={setAddActRastreoShowModal}
          onUpdateActRastreoData={handleUpdateActRastreoData} //PARTE DE LA FUNCION handleUpdateActRastreoData
          ...
          onClose={() => {
            setAddActRastreoShowModal(false); //Cerrar la modal
